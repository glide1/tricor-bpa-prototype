...
(function ($) {
    ...
    var App = {
        iscrollCfg: { mouseWheel: !isMobile, scrollbars: !isMobile },
        refresh: refreshScrolls
    };

    App.$ = App.jQuery = $;

    /*$('.iscroll').each(function () {
        scrolls.push(new IScroll(this, App.iscrollCfg));
    });*/
    ...
    $(window).resize(function () {
        ...
        timeout = setTimeout(refreshScrolls, 300);
    });
